...
translate French strings:
    ...
    new "Chute de volume de l'auto-voix"

    # renpy/common/00accessibility.rpy:235
    old "The options on this menu are intended to improve accessibility. They may not work with all games, and some combinations of options may render the game unplayable. This is not an issue with the game or engine. For the best results when changing fonts, try to keep the text size the same as it originally was."
    new "Les options de ce menu visent à améliorer l'accessibilité. Ils peuvent ne pas fonctionner avec tous les jeux et certaines combinaisons d'options peuvent rendre le jeu injouable. Ce n'est pas un problème avec le jeu ou le moteur. Pour de meilleurs résultats lors de la modification des polices, essayez de conserver la taille du texte telle qu’elle était à l’origine."
    ...
    new "sauter invisible [text]"

    # renpy/common/00preferences.rpy:360
    old "skip unseen text"
    new "sauter le texte invisible"
    ...
    new "audio lorsque la mise au point est floue"
    ...
    new "Le serveur Ren'Py Sync ne possède pas de copie de cette synchronisation. L'ID de synchronisation n'est peut-être pas valide ou son délai d'attente a expiré."
    ...
    new "Le fichier {a=edit:1:log.txt}log.txt{/a} peut contenir des informations pour vous aider à déterminer le problème avec votre ordinateur."
